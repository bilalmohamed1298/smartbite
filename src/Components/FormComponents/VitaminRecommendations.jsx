...
const VitaminRecommendations = () => {
    ...
    const missingVitamins = JSON.parse(localStorage.getItem('vitaminDeficiencies')).flatMap((vitamin )=>vitamin.split(", "));
        ...
        <Grid container spacing={3}>
          {missingVitamins.map((vitamin) => (
            <Grid item xs={12} sm={6} key={vitamin}>
              <Card sx={{ bgcolor: "#fbf6fe", borderRight: "5px solid #A34BCE", borderRadius: 2 }}>
                <CardContent>
